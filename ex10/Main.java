...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        students[0]=new Student10("Андрей", "Логинов    ", "Тестировщик", 2, "ИВБО-08-21");
        students[1]=new Student10("Руслан", "Шеболденков", "Программист", 4, "ИВБО-08-19");
        students[2]=new Student10("Антон ", "Маркин     ", "Инфобез    ", 5, "БСБО-05-18");
        students[3]=new Student10("Иван  ", "Иванов     ", "Филолог    ", 3, "ИВБО-04-20");
        students[4]=new Student10("Пётр  ", "Петров     ", "Историк    ", 1, "ИВБО-02-22");
